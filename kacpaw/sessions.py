...
class KASession(requests.Session): # todo: attempt to use the OAuth flow again
    ...
    def login(self, username, password):
        ...
        # I'm a little unclear about the nature of KA fkeys, but you can recieve them by going to /login and they seem to persist throughout the session - at least I hope so!
    ...
    # note that although there is a user_id property which may sound like the id from Content subclasses, KASessions are not in any way related to content.  There is no id property for one, and sessions cannot be tested for equality, hashed, etc...
    @property
    def user_id(self):
